...
\begin{figure}[H]
    \includegraphics[width=11cm]{figures/boundaries_growth} % The name of your image file; assumes it is in the same directory as your .tex file
    \vspace{2pt}
...
\textbf{System parameters for numerical simulation}. Value 1 parameters are used for Figs ~\ref{fig1}, \ref{fig:dispersions}, \ref{fig:multistability1}, and \ref{fig:multistability2}, as well as~\nameref{sup_fig2}, \nameref{sup_fig3}, and \nameref{sup_fig4}. Value 2 parameters are used for Fig~\ref{fig:boundariesgrowth} and ~\nameref{sup_fig5}.
